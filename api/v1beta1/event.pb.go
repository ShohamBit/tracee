...
type Process struct {
	...
	UniqueId   *wrappers.UInt32Value `protobuf:"bytes,2,opt,name=unique_id,json=uniqueId,proto3" json:"unique_id,omitempty"`
	HostPid    *wrappers.UInt32Value `protobuf:"bytes,3,opt,name=host_pid,json=hostPid,proto3" json:"host_pid,omitempty"`
	Pid        *wrappers.UInt32Value `protobuf:"bytes,4,opt,name=pid,proto3" json:"pid,omitempty"`
...
func (x *Process) GetUniqueId() *wrappers.UInt32Value {
	if x != nil {
		return x.UniqueId
	}
	return nil
...
func (x *Process) GetHostPid() *wrappers.UInt32Value {
	if x != nil {
		return x.HostPid
	}
	return nil
...
type Thread struct {
	...
	UniqueId       *wrappers.UInt32Value `protobuf:"bytes,3,opt,name=unique_id,json=uniqueId,proto3" json:"unique_id,omitempty"`
	HostTid        *wrappers.UInt32Value `protobuf:"bytes,4,opt,name=host_tid,json=hostTid,proto3" json:"host_tid,omitempty"`
	Tid            *wrappers.UInt32Value `protobuf:"bytes,5,opt,name=tid,proto3" json:"tid,omitempty"`
...
func (x *Thread) GetStartTime() *timestamp.Timestamp {
	if x != nil {
		return x.StartTime
	}
	return nil
...
func (x *Thread) GetUniqueId() *wrappers.UInt32Value {
	if x != nil {
		return x.UniqueId
	}
	return nil
...
func (x *Thread) GetHostTid() *wrappers.UInt32Value {
	if x != nil {
		return x.HostTid
	}
	return nil
...
func file_api_v1beta1_event_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1beta1_event_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_api_v1beta1_event_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_api_v1beta1_event_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_api_v1beta1_event_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_api_v1beta1_event_proto_msgTypes[11].Exporter = func(v any, i int) any {
			switch v := v.(*K8S); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1beta1_event_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*Pod); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1beta1_event_proto_msgTypes[13].Exporter = func(v any, i int) any {
