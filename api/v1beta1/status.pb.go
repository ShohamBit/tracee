...
type StatusInfo struct {
	...
	Uptime  *timestamp.Timestamp `protobuf:"bytes,1,opt,name=uptime,proto3" json:"uptime,omitempty"`   // Service uptime
...
func (x *StatusInfo) GetUptime() *timestamp.Timestamp {
	if x != nil {
		return x.Uptime
	}
	return nil
...
func (x *StatusInfo) GetPid() int32 {
	if x != nil {
		return x.Pid
	}
	return 0
...
type PerformanceSummary struct {
	...
	MemoryUsage                int32 `protobuf:"varint,1,opt,name=memory_usage,json=memoryUsage,proto3" json:"memory_usage,omitempty"`                                                  // Memory usage in MB
	CpuUsage                   int32 `protobuf:"varint,2,opt,name=cpu_usage,json=cpuUsage,proto3" json:"cpu_usage,omitempty"`                                                           // CPU usage percentage
	NetworkLatency             int32 `protobuf:"varint,3,opt,name=network_latency,json=networkLatency,proto3" json:"network_latency,omitempty"`                                         // Network latency in ms
	AverageEventProcessingTime int32 `protobuf:"varint,4,opt,name=average_event_processing_time,json=averageEventProcessingTime,proto3" json:"average_event_processing_time,omitempty"` // Avg time per event in ms
}
...
func (x *PerformanceSummary) GetMemoryUsage() int32 {
	if x != nil {
...
func (x *PerformanceSummary) GetCpuUsage() int32 {
	if x != nil {
		return x.CpuUsage
	}
	return 0
...
func (x *PerformanceSummary) GetNetworkLatency() int32 {
	if x != nil {
...
func (x *PerformanceSummary) GetAverageEventProcessingTime() int32 {
	if x != nil {
		return x.AverageEventProcessingTime
	}
	return 0
}
...
type PolicySummary struct {
	...
	NumberOfPolicies int32 `protobuf:"varint,1,opt,name=number_of_policies,json=numberOfPolicies,proto3" json:"number_of_policies,omitempty"` // Total number of policies
}
...
func (x *PolicySummary) GetNumberOfPolicies() int32 {
	if x != nil {
...
type StreamSummary struct {
	...
	ActiveStreams int32 `protobuf:"varint,1,opt,name=active_streams,json=activeStreams,proto3" json:"active_streams,omitempty"` // Number of active streams
}
...
func (x *StreamSummary) GetActiveStreams() int32 {
	if x != nil {
...
type ArtifactCaptureStatus struct {
	...
	CapturedArtifacts string `protobuf:"bytes,2,opt,name=captured_artifacts,json=capturedArtifacts,proto3" json:"captured_artifacts,omitempty"` // Description of captured artifacts
	StorageLocation   string `protobuf:"bytes,3,opt,name=storage_location,json=storageLocation,proto3" json:"storage_location,omitempty"`       // Storage location for artifacts
}
...
var file_api_v1beta1_status_proto_rawDesc = []byte{
	...
	,
	...
	0x70, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x70, 0x69, 0x64, 0x22, 0xc0,
	0x01, 0x0a, 0x12, 0x50, 0x65, 0x72, 0x66, 0x6f, 0x72, 0x6d, 0x61, 0x6e, 0x63, 0x65, 0x53, 0x75,
	0x6d, 0x6d, 0x61, 0x72, 0x79, 0x12, 0x21, 0x0a, 0x0c, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f,
	0x75, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x6d, 0x65, 0x6d,
	...
	,
	...
	,
...
var file_api_v1beta1_status_proto_depIdxs = []int32{
	...
	9, // 7: tracee.v1beta1.StatusInfo.uptime:type_name -> google.protobuf.Timestamp
